...
public class PopcornCounterActivity extends Activity
{
	...
	ArrayList<PopcornSold> arrayList;// = new ArrayList<PopcornSold>();
        ...
        for (Iterator<PopcornSold> iter = arrayList.iterator(); iter.hasNext();)
		{
            ...
            cb.setOnClickListener(new View.OnClickListener() 
            {
	            public void onClick(View v)
	            {
	                ...
	                Intent myIntent = new Intent(v.getContext(), PopcornUpdateActivity.class);
	...
	public static final void saveGsFilex(Context context, ArrayList<PopcornSold> newArray)
	{
		try
		{
			FileOutputStream fos = context.openFileOutput(GS_SALES_FILE, Context.MODE_PRIVATE);
